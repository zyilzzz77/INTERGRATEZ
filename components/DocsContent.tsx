    ...
    return (
        <div className="min-h-screen bg-neutral-900 px-4 py-12 text-neutral-200">
            ...
            >
                ...
                {/* Navigation */}
                <motion.div variants={item} className="mb-12 flex flex-wrap justify-center gap-3">
                ...
                <div className="space-y-12">
                    {/* SECTION: DOWNLOADER */}
                    <motion.section variants={item} id="downloader" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                    ...
                    <motion.section variants={item} id="search" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
                    ...
                    {/* SECTION: TOOLS */}
                    <motion.section variants={item} id="tools" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
                    ...
                    {/* SECTION: STALKER */}
                    <motion.section variants={item} id="stalker" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
