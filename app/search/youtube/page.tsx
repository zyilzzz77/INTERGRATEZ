    ...
    const handlePlaylistSubmit = async () => {
        ...
        try {
            ...
            if (data.error) {
                ...
                setPlaylistError("Tidak ada data playlist ditemukan");
            }
        } catch {
            setPlaylistError("Gagal mengambil playlist");
        } finally {
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowPlaylistModal(false)}>
                    ...
                    >
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="text-lg font-bold text-white">📋 YouTube Playlist</h2>
                            <button
                        ...
                        <p className="mb-4 text-sm text-neutral-500">
                            Paste URL playlist YouTube untuk mengambil semua video dalam playlist.
                        </p>
                        <input
                            type="text"
                            value={playlistUrl}
                ...
                <div className="mt-10">
                    <div className="mb-5 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-white">Playlist Result</h2>
                                <p className="text-xs text-neutral-500">{playlistResults.length} video ditemukan</p>
                            </div>
                        </div>
                        <button
