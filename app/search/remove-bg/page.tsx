    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-10">
            ...
            <div className="mb-10 text-center">
                <div className="mb-3 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 text-2xl text-white shadow-lg shadow-purple-500/20">
                    <ImageIcon className="w-7 h-7" />
                </div>
                <h1 className="text-3xl font-black text-white">
                    Remove <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Background</span>
                </h1>
                <p className="mt-2 text-sm text-neutral-500">
                    Upload gambar, hapus background secara otomatis
                </p>
            </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-4">
                            ...
                            <div className="relative aspect-square overflow-hidden rounded-xl" style={{
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        {!resultUrl && (
                            <button
                                ...
                                disabled={loading}
                                className="flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 text-sm font-bold text-white shadow-lg shadow-purple-500/25 transition hover:shadow-xl hover:shadow-purple-500/30 disabled:opacity-50"
                            >
                                {loading ? (
