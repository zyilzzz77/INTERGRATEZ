...
export const metadata = {
    title: "Dokumentasi Penggunaan - Intergratez",
    description: "Panduan lengkap cara menggunakan fitur downloader, search, dan tools lainnya di Intergratez.",
};
        ...
        <div className="min-h-screen bg-neutral-900 px-4 py-12 text-neutral-200">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="space-y-12">
                    {/* SECTION: DOWNLOADER */}
                    <section id="downloader" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                    ...
                    <section id="search" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
                    ...
                    {/* SECTION: TOOLS */}
                    <section id="tools" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
                    ...
                    {/* SECTION: STALKER */}
                    <section id="stalker" className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        <div className="mb-6 flex items-center gap-3 border-b border-white/10 pb-6">
...
function SearchItem({ icon, title, url, desc, query }: { icon: string, title: string, url: string, desc: string, query: string }) {
    return (
        <div className="flex flex-col rounded-xl border border-white/5 bg-black/20 p-5 transition hover:border-white/20">
